...
import {GET_PRODUCTS_BY_CATEGORIES} from '@root/_src/override/components/AddonPopularSlider/services/schema';
import {withProfiler} from '@sentry/react-native';
import {customUseQuery} from '@app/hooks/customApolloHooks';
import {navigateTo} from '@app/helpers/Navigation';
import {modules} from '@root/swift.config';

import Views from '@root/_src/override/components/AddonPopularSlider/views';

const PopularProductSlider = ({categoryId, title}) => {
  /**
   * ----------------------------------------- *
   * @constant
...
export default withProfiler(PopularProductSlider, {
  name: 'PopularProductSlider',
});
